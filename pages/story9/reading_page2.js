          ...
          <TouchableOpacity
            ...
            onPress={() => {
              if (question2[0].includes('choice')) {
                navigation.navigate('st9_choiceQuestion', {story2, question2});
              } else if (question2[0].includes('Write')) {
                navigation.navigate('st9_fillQuestion2', {story2, question2});
              } else if (question2[0].includes('Drag')) {
                navigation.navigate('st9_dragGame', {story2, question2});
              } else if (question2[0].includes('Sort')) {
                navigation.navigate('st9_sortGame', {story2, question2});
              }
