          ...
          <TouchableOpacity
            ...
            onPress={() => {
              if (question2[0].includes('choice')) {
                navigation.navigate('st8_choiceQuestion2', {story2, question2});
              } else if (question2[0].includes('Write')) {
                navigation.navigate('st8_fillQuestion', {story2, question2});
              } else if (question2[0].includes('Drag')) {
                navigation.navigate('st8_dragGame', {story2, question2});
              } else if (question2[0].includes('Sort')) {
                navigation.navigate('st8_sortGame', {story2, question2});
              }
