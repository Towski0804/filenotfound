        ...
        <View style={styles.buttonHolder}>
          ...
          {options.map((item, key) => (
            <TouchableOpacity
              ...
              onPress={() => {
                if (item == question1[1]) {
                  navigation.navigate('st10_rightAnswer', {story2, question2});
                } else if (typeof item === 'string') {
                  if (item.includes(question1[1])) {
                    navigation.navigate('st10_rightAnswer', {
                      story2,
                      question2,
                    });
                  } else {
                    navigation.navigate('st10_falseAnswer', {
                      story2,
                      question2,
                    });
                  }
                } else {
                  navigation.navigate('st10_falseAnswer', {story2, question2});
                }
              }}>
