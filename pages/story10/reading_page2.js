          ...
          <TouchableOpacity
            ...
            onPress={() => {
              if (question2[0].includes('choice')) {
                navigation.navigate('st10_choiceQuestion2', {
                  story2,
                  question2,
                });
              } else if (question2[0].includes('Write')) {
                navigation.navigate('st10_fillQuestion2', {story2, question2});
              } else if (question2[0].includes('Drag')) {
                navigation.navigate('st10_dragGame', {story2, question2});
              } else if (question2[0].includes('Sort')) {
                navigation.navigate('st10_sortGame', {story2, question2});
              }
